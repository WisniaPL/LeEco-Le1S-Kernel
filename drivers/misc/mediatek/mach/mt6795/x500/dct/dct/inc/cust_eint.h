...
#define CUST_EINT_CC_DECODER_NUM              2
#define CUST_EINT_CC_DECODER_DEBOUNCE_CN      0
#define CUST_EINT_CC_DECODER_TYPE							CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_CC_DECODER_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
